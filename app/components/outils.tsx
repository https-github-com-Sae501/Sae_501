...
interface ChildProps {
  onChildInfo: (info: number) => void;
}

const Outils: React.FC<ChildProps> = ({ onChildInfo }) => {
  ...
  return (
    <div className="fixed left-10 top-1/2 transform -translate-y-1/2  border-2 border-black rounded-lg w-max h-max">
      <div className=" flex flex-col gap-10 p-3">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="35" height="38" viewBox="0 0 35 38" fill="none" className="cursor-pointer" onClick={() => handleOptionClick(4)}>
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="32" height="36" viewBox="0 0 32 36" fill="none" className="cursor-pointer" onClick={() => handleOptionClick(2)}>
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="31" height="36" viewBox="0 0 31 36" fill="none" className="cursor-pointer" onClick={() => handleOptionClick(1)}>

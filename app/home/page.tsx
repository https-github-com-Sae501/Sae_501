...
const Home = () => {
  ...
  return (
    <div className="bg-zinc-900 h-screen w-screen color-foreground text-white flex flex-col justify-center items-center">
    <Header />
    <div className='h-full overflow-x-scroll p-4'>
      <h1 className='text-4xl font-bold p-2 pt-12 pb-6 text-white mb-20 text-center'>Sculpt</h1>
        ...
        <div className='pl-3 pb-3 text-xl text-white'>
          ...
          <div className='flex flex-row justify-between items-center mb-20 border'>

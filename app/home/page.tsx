  ...
  return (
    <div className="bg-white h-screen w-screen color-foreground text-black">
      ...
      <div className='h-full overflow-x-scroll p-4'>
        <h1 className='text-4xl font-bold p-2 pt-12 text-black'>Sculpt</h1>
        <div className='pl-3 pb-3 text-xl text-black'>
          <p className=''>Sculpt is a stone carving game. The principle is simple: you have 3 cube sizes to choose from, small, medium and large.</p>

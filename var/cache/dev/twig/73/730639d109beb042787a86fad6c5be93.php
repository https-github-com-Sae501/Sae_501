...
class __TwigTemplate_3877b02b995ceccb950b876fdd6dc558 extends Template
{
    private $source;
    private $macros = [];
...
<section class=\"container my-3\">
    <div class=\"row\">
        ...
        echo "\" class=\"btn btn-secondary mt-3\">S'inscrire</a>
            </form>
        </div>
    </div>
</section>
...
";
    ...
    {
        return array (  144 => 45,  138 => 41,  132 => 28,  124 => 23,  119 => 20,  111 => 17,  108 => 16,  106 => 15,  103 => 14,  97 => 12,  95 => 11,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
    ...
    <div class=\"row\">
        <div class=\"col\">
            <form method=\"post\">
                ...
                {% if app.user %}
                    <div class=\"mb-3\">
                        tu es connecter en tant que {{ app.user.userIdentifier }}, <a href=\"{{ path('app_logout') }}\">Me déconnecter</a>
                    </div>
                {% endif %}
                ...
                <a href=\"{{ path('app_register') }}\" class=\"btn btn-secondary mt-3\">S'inscrire</a>
            </form>
        </div>
    </div>
</section>
...
{% endblock %}
", "security/login.html.twig", "C:\\Users\\sellay1\\Desktop\\Sae_501\\templates\\security\\login.html.twig");
    }
}

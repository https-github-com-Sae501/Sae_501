...
class ApiPlatformConfig implements \Symfony\Component\Config\Builder\ConfigBuilderInterface
{
    ...
    */
     ...
     */
    public function doctrineMongodbOdm(mixed $value = []): \Symfony\Config\ApiPlatform\DoctrineMongodbOdmConfig|static
    {
        if (!\is_array($value)) {
     ...
     */
    public function oauth(mixed $value = []): \Symfony\Config\ApiPlatform\OauthConfig|static
    {
        if (!\is_array($value)) {
    ...
    */
     ...
     */
    public function mercure(mixed $value = []): \Symfony\Config\ApiPlatform\MercureConfig|static
    {
        if (!\is_array($value)) {
    ...
    */
     ...
     */
    public function elasticsearch(mixed $value = []): \Symfony\Config\ApiPlatform\ElasticsearchConfig|static
    {
        if (!\is_array($value)) {
    ...
    */
     ...
     */
    public function formats(string $format, mixed $value = []): \Symfony\Config\ApiPlatform\FormatsConfig|static
    {
        if (!\is_array($value)) {
     ...
     */
    public function patchFormats(string $format, mixed $value = []): \Symfony\Config\ApiPlatform\PatchFormatsConfig|static
    {
        if (!\is_array($value)) {
     ...
     */
    public function errorFormats(string $format, mixed $value = []): \Symfony\Config\ApiPlatform\ErrorFormatsConfig|static
    {
        if (!\is_array($value)) {

 ...
 */
class getCubeRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CubeRepository' shared autowired service.
     *
     * @return \App\Repository\CubeRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CubeRepository.php';

        return $container->privates['App\\Repository\\CubeRepository'] = new \App\Repository\CubeRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}

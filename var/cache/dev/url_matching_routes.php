...
return [
    false, // $matchHost
    [ // $staticRoutes
        '/authentication_token' => [[['_route' => 'tokenapp_auth_gettoken', '_controller' => 'App\\Controller\\AuthController::getToken'], null, ['POST' => 0], null, false, false, null]],
    ],
    [ // $regexpList
        0 => '{^(?'
                .'|/api(?'
    ...
    [ // $dynamicRoutes
        ...
        293 => [[['_route' => 'app_user_createuser', '_controller' => 'App\\Controller\\UserController::createUser'], [], ['POST' => 0], null, false, false, null]],
        332 => [

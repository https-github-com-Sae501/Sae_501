 ...
 */
class getSculptRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\SculptRepository' shared autowired service.
     *
     * @return \App\Repository\SculptRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'SculptRepository.php';

        return $container->privates['App\\Repository\\SculptRepository'] = new \App\Repository\SculptRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
